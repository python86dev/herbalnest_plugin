...
(function($) {
    ...
    $(document).ready(function() {
        console.log('Herbal Product Template JavaScript loaded');
        console.log('herbalTemplateData:', typeof herbalTemplateData !== 'undefined' ? herbalTemplateData : 'undefined');
    ...
    function initIngredientModals() {
        ...
        const ingredientCards = $('.herbal-ingredient-card');
        
        console.log('Initializing ingredient modals...');
        console.log('Found ingredient cards:', ingredientCards.length);
        console.log('Modal found:', modal.length);
        
        // Handle ingredient card clicks and enter key
        ingredientCards.on('click keydown', function(e) {
            if (e.type === 'click' || (e.type === 'keydown' && (e.key === 'Enter' || e.key === ' '))) {
                e.preventDefault();
                const ingredientId = $(this).data('ingredient-id');
                console.log('Ingredient card clicked, ID:', ingredientId);
    ...
    function openIngredientModal(ingredientId) {
        ...
        console.log('Opening modal for ingredient ID:', ingredientId);
        console.log('herbalTemplateData available:', typeof herbalTemplateData !== 'undefined');
        ...
        if (typeof herbalTemplateData !== 'undefined' && 
            ...
            console.log('Found ingredient data:', ingredient);
            ...
            console.log('No ingredient data found in herbalTemplateData, using AJAX fallback');
